      ...
      <main className="flex flex-1 flex-col items-center justify-center">
        <div className="relative mx-4 my-8 flex h-full flex-col justify-end rounded-3xl bg-[linear-gradient(180deg,_#FFAA8E,_#FF765E)]">
          <div className="top-choice-text absolute w-full">
            <span className="bg-orange1 inline-block rounded-full px-5 py-2 font-pretendardSemiBold text-[1.0625rem] text-white">
              {badge}
            </span>
            <TItle
              text1={title1}
              text2={title2}
              img=""
              className="color-white text-l mb-6 font-bold text-white"
            />
            <Guide
              text1={guide1}
              text2={guide2}
